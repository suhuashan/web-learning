...
function Watcher(name, el, vm, exp, attr) {
    this.name = name; //指令绑定的节点名称如‘input’，‘text’
    this.el = el; //指令对应的DOM元素
    this.vm = vm; //指令所属Vue实例
    this.exp = exp; //指令对应的data的属性值，本例如"number"
    this.attr = attr; //实际dom绑定的属性值，input对应value,普通标签对应'innerHTML'
    this.update();
}
